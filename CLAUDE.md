...
- docs/HANDOFF.md is the authoritative reference for architecture and rules math. docs/RELEASE.md covers build channels (stable vs beta) and the release/publish workflow — read it before drafting a version for release.
